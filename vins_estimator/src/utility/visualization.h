...
extern rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr pub_path, pub_pose, pub_groundtruth;
...
extern nav_msgs::msg::Path path, groundtruth_path;
...
void pubGroundTruth(Estimator &estimator, const std_msgs::msg::Header &header, Eigen::Matrix<double, 7, 1>& pose, const double td);//仿真用
